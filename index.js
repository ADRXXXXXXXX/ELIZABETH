...
PARA VER MEUS COMANDOS DIGITE .ajuda`
	...
	const speed = require('performance-now');
			...
			mess = {
				...
				grave: 'ESSE FICA UM POUCO RUIM (ESTOU PROCESSANDO)',
				grave1: 'ESSE FICA UMA TONALIDADE BOA (ESTOU PROCESSANDO)',
				success: 'ENCONTREI🤩⚡',
				...
				only: {
					...
					ownerB: '❌ VC N E MEU DONO MEU DONO ENTT N PODERÁ USSR ESTE COMANDO❌',
...
case 'leveling':
            ...
            break
				...
				buffer = await getBuffer(`https://cdn.discordapp.com/attachments/832041762352529488/839139111449133146/20210504_105856.png`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: `●𒊹︎ᏴϴͲ𒊹︎︎︎𝗘𝗟𝗜𝗭𝗔𝗕𝗘𝗧𝗛𒊹︎︎︎*ESTE BOT ESTA EM FAZE DE TESTE*●
●𒊹︎︎︎𝐃𝐎𝐍𝐎𒊹︎︎︎𝐀𝐃𝐑𝐗 wa.me/558197660171𒊹︎︎︎●
...
╠➥🌟${prefix}abrirgp "abrir este grupo"
╠➥🌟${prefix}linkgp "link do grupo
╠➥🌟${prefix}listademar "adms deste grup"
...
╠══════════════════════
 <EM BREVE TERÁ MAIS COMANDOS✔️✔️>            
╠═════════════════════════`})
